CREATE DATABASE IF NOT EXISTS PASANTE;
...
INSERT INTO USUARIOS VALUES (NULL, 'Moonlight', 'SI');
...
INSERT INTO TEXTOS VALUES (NULL, '{P1} se sentó a fumar un pase de montecristo cuando {P2} se le acerco y pidió... {P2} al ver que era de buena calidad se hizo le loque fumándosele completo, {P1} al verle le cayó a lepe hasta producirle fractura de cráneo.', 'NO');
...
INSERT INTO TEXTOS VALUES (NULL, '{P1} se mete caleta 10 lineas de cocaina, empericade le salta a {P2} y le clava 28 veces un lapicero mientras le grita chavista.', 'NO');
INSERT INTO TEXTOS VALUES (NULL, '{P1} cuadra con {P2} para ver Netflix juntes, al final era una trampa y solo tenia telecaribe con juana la iguana, {P1} se le tira y le cae a lata hasta matarle… el capítulo de juana la iguana era repetido.', 'NO');
INSERT INTO TEXTOS VALUES (NULL, '{P1} le ofreció prepararle unas arepas a {P2}, lo que nuestre amige no sabe es que tiene diablo rojo y al comerlo le limpio hasta el alma y termino en el cielo.', 'NO');
...
INSERT INTO TEXTOS VALUES (NULL, '{P2} le debe plata a {P1}, como ya tiene tiempo sin pagarle, {P1} le dice a unos panas que son MotoPiruetas que le den un susto a {P2}, como los MotoPiruetas no creen en naiden le echaron plomo a {P2}, al no ser malandre no pudo aguantar el plomo y valió vergulis.', 'NO');
